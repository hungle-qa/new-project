---
digest-version: 3
generated: 2026-03-10T07:53:30.851Z
feature: booking--us3-us9
sources:
  - source/testcase/feature/booking--us3-us9/config.md
  - source/testcase/feature/booking--us3-us9/spec/*.md
...
-   Then:
    ...
    -   The Create session type form should include the following fields and behaviors:
        ...
        -   **Session type color:**
            ...
            -   Default to "Blue".
            -   On click, should display the color list.
            -   The Color should be displayed as per this order:
                -   1. Red
                -   2. Orange
                -   3. Yellow
                -   4. Green
        ...
        -   **Duration:**
            ...
            -   Should display the available option in a dropdown list (15 min, 30 min, 45 min, 60 min, 90 min, 120 min) - have hover state.
                ...
                -   Click on an available option on the dropdown should:
...
-   Given: The Session Types list is displayed  /  The session type is active
...
-   Given: The Session Types list is displayed  /  The session type is archived
-   When: I click the Action menu icon on a row
-   Then:
    -   Should display a contextual dropdown menu aligned to the icon, containing:
        -   Edit
...
-   Given: I am on the Active tab  /  An item is archived
